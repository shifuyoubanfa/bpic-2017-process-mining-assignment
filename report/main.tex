...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{../figures/process_models/final_heuristics_bpmn.pdf}
    \caption{Final BPMN 2.0 process model derived from the selected Heuristics Miner model.}
    \label{fig:finalbpmn}
\end{figure*}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{../figures/process_models/final_decision_aware_bpmn.pdf}
    \caption{Compact decision-aware BPMN-style view with mined decision blocks for the two selected XOR decisions.}
